 ...
 */
namespace LR\Matrixtable\Block\Product\View\Options\Type;
    ...
    public function getValuesHtml()
    {
            ...
            foreach ($_option->getValues() as $_value) {
                ...
                $select->addOption(
                    ...
                    ['price' => $this->pricingHelper->currencyByStore($_value->getPrice(true), $store, false),
                     'option-value' => strtolower(str_replace(' ','-',$_value->getTitle())),
                     'option-title' => $_value->getTitle()  
                    ]
                );
            }
        ...
        if ($_option->getType() == \Magento\Catalog\Api\Data\ProductCustomOptionInterface::OPTION_TYPE_RADIO ||
            ...
            foreach ($_option->getValues() as $_value) {
                ...
                $qtyStr = '';
                $qtyClass = ' class="option-label"';
                 if (strtolower(str_replace(' ', '-', $_option->getTitle())) == "quantity") {
                        $qtyStr = '<div class="qty-custom-price-class"></div>';
                        $qtyClass = ' class="option-label qty-value"';
                    }
                ...
                $selectHtml .= '<div class="field choice admin__field admin__field-option' .
                    ...
                    '_' .
                    $count .
                    '" option-value='.$_value->getTitle().'><span'.$qtyClass.' >' .
                    $_value->getTitle() .
                    '</span> ' .
                    $qtyStr.
                    '</label>';
