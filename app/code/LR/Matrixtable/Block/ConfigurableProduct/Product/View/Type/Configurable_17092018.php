    ...
    public function getJsonConfig()
    {
        ...
        if (!empty($currentProduct)) {
            ...
            foreach ($optionsConfig as $sku => $d) {
                ...
                $simpleProductArray[$pr->getId()] = $this->priceCurrency->getCurrency()->getCurrencySymbol() . $this->localeFormat->getNumber($pr->getPrice());
            }
            ...
            $config['currency'] = $this->priceCurrency->getCurrency()->getCurrencySymbol();
