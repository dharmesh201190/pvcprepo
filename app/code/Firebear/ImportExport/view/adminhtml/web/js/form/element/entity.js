        ...
        return Abstract.extend(
            {
                ...
                onUpdate: function () {
                    ...
                    $('.admin__field').each(function () {
                        ...
                        if (
                            dataIndex == 'clear_attribute_value' || 
                            dataIndex == 'remove_product_association' || 
                            dataIndex == 'remove_product_website' || 
                            dataIndex == 'remove_product_categories' || 
                            dataIndex == 'root_category_id' || 
                            dataIndex == 'remove_images' || 
                            dataIndex == 'remove_related_product'
                        ) {
